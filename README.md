...
> Answer: Client side routing allows less data to be processed so routing between views is faster, however the whole application has to be loaded on first request which may take longer for an initial load
